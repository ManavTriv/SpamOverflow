...
class Email(db.Model):
    ...
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.now(timezone.utc).astimezone())
    # The date and time the email was updated including its creation.
    updated_at = db.Column(db.DateTime, nullable=False, default=datetime.now(timezone.utc).astimezone(), onupdate=datetime.now(timezone.utc).astimezone())
